...
function styleTa(){ta.style.position="relative";ta.style.background="none";ta.style.backgroundColor="transparent";ta.style.zIndex="1";}
...
function makeMark(m){m="<mark class=\""+m+"\">$&</mark>";return m;}
...
setup(b,t,re,c);return{init:function(b,t,re,c){setup(b,t,re,c);},setCorners:function(c){modCrnrs(c);},setHighlights:function(re){setRegexes(re);onInput();onResize();},update:function(){onInput();onResize();onScroll();},destroy:function(){cleanUp();}};};
